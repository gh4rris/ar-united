...
SELECT users.id, users.first_name, users.last_name, users.dob, users.created_at, users.updated_at, users.email, users.slug, users.profile_pic_url, users.hashed_password
FROM users
